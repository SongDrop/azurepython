...
GALLERY_IMAGE_NAME = 'ps2'
GALLERY_IMAGE_VERSION = '1.0.2'
OS_DISK_SSD_GB = '256'
WINDOWS_IMAGE_PASSWORD = 'ps2DevKitRTX1!'
...
async def main():
    ...
    pc_name = ''.join(random.choices(string.ascii_lowercase, k=6)) + "ps2"
   ...
   # Define Trusted Launch security profile
    ...
    if extension:
        ...
        print_success("-----------------------------------------------------")
        # Construct the URL
        url = f"https://cdn.sdappnet.cloud/rtx/rtxps2.html?url={public_ip}"
        ...
        html_content = html_email.HTMLEmail(
            ...
            background_image_url="https://i.postimg.cc/XvBKkm5L/ps2wallpaper.png",
            ...
            image_left_src="",
            image_right_src="",
            logo_src="https://i.postimg.cc/DZj2fjjV/ps2banner.png",
            company_src="https://i.postimg.cc/0NN5g1nG/pspal.png",
